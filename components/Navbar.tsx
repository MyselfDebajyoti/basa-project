...
//       {/* Full-Screen Dropdown Menu */}
//       {isMenuOpen && (
//         <div className="fixed inset-0 top-[76px] z-40 bg-black bg-opacity-50 lg:absolute lg:bg-transparent">
//           <div
...
//             <div className="flex justify-end bg-gray-50 border-b">
//               <Button
//                 variant="ghost"
//                 size="sm"
//                 onClick={() => setIsMenuOpen(false)}
    ...
    <>
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 top-[76px] z-40 md:pt-8 pt-2 bg-black bg-opacity-50 lg:absolute lg:bg-transparent">
          ...
          >
            {/* Close button - positioned better for mobile */}
            {/* <div className="flex justify-end bg-background border-b">
              <Button
                variant="ghost"
                size="sm"
                onClick={() => setIsMenuOpen(false)}
